...
public class BookingController {
	...
	public BookingController(BookingService bookingService, BookingMapper bookingMapper,
			CustomerService customerService, ServicePlanService planService, ResponseBuilder responseBuilder) {
	...
	public ResponseEntity<ApiResponse<BookingResponse>> create(@RequestBody BookingRequest request) {
	    ...
	    return responseBuilder.created(response, "Booking created successfully");
	}
